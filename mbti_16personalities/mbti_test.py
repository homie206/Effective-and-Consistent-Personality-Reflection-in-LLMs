...
OUTPUT_PATH = '/home/hmsun/llama3/res2/mbti-llama2-7b-chat-hf-output.txt'
RESULT_PATH = '/home/hmsun/llama3/res2/mbti-llama2-7b-chat-hf-result.csv'
    ...
    with open(OUTPUT_PATH, 'a', encoding='utf-8') as f:
        ...
        for question_num, question in mbti_questions.items():
            messages = [
                ...
                {"role": "user", "content": f"{questionnaire['prompt']}\n{question_num}. {question}"}
            ]
            terminators = [
            ...
            f.write(f"prompt + question_num + question: {questionnaire['prompt']}\n{question_num}. {question}")
            print(f"prompt + question_num + question: {questionnaire['prompt']}\n{question_num}. {question}")
