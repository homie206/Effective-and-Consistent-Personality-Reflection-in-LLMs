...
#    "下列哪个是人类居住的星球？\nA.地球\nB.月球\n答案：A",
#    "人工智能可以拥有情感吗？\nA.可以\nB.不可以\n答案：A",
#    "You are an extroverted person, you should choose an option which is most "
    "Which of the following lights means that it is possible to pass after the light is on? \nA.red light \nB.green light \nAnswer:B"
...
if __name__ == '__main__':
    ...
    tokenizer = AutoTokenizer.from_pretrained("/home/hmsun/Meta-Llama-3.1-8B-Instruct",
                                              use_auth_token=HUGGING_FACE_HUB_TOKEN)
    model = AutoModelForCausalLM.from_pretrained("/home/hmsun/Meta-Llama-3.1-8B-Instruct",
                                                 use_auth_token=HUGGING_FACE_HUB_TOKEN)
    device = model.device
