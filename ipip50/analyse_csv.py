...
# 读取 CSV 文件
file_path = '/home/hmsun/llama3/ipip_50/result/updated_test_scores.csv'
...
# 将结果写入 TXT 文件
with open('/home/hmsun/llama3/ipip_50/result/average_and_counts.txt', 'w') as f:
    f.write('\n'.join(output_lines))

# 将高低列写回原 CSV 文件
df.to_csv(file_path, index=False)

print("处理完成，结果已写入 TXT 文件和更新后的 CSV 文件。")
